...
Schedule_t slAssassinExposed[] =
{
	{
		tlAssassinExposed,
		ARRAYSIZE_HL ( tlAssassinExposed ),
		bits_COND_CAN_MELEE_ATTACK1,
		0,
		"AssassinExposed",
	},
...
Schedule_t	slAssassinTakeCoverFromEnemy[] =
{
	{ 
		...
		ARRAYSIZE_HL ( tlAssassinTakeCoverFromEnemy ), 
		bits_COND_NEW_ENEMY |
		bits_COND_CAN_MELEE_ATTACK1		|
		bits_COND_HEAR_SOUND,
...
Schedule_t	slAssassinTakeCoverFromEnemy2[] =
{
	{ 
		...
		ARRAYSIZE_HL ( tlAssassinTakeCoverFromEnemy2 ), 
		bits_COND_NEW_ENEMY |
...
Schedule_t	slAssassinTakeCoverFromBestSound[] =
{
	{ 
		...
		ARRAYSIZE_HL ( tlAssassinTakeCoverFromBestSound ), 
		bits_COND_NEW_ENEMY,
		0,
...
Schedule_t	slAssassinJumpAttack[] =
{
	{ 
		...
		ARRAYSIZE_HL ( tlAssassinJumpAttack ), 
		0, 
		0,
		"AssassinJumpAttack"
	},
...
Schedule_t	slAssassinJumpLand[] =
{
	{ 
		tlAssassinJumpLand,
		ARRAYSIZE_HL ( tlAssassinJumpLand ), 
		0, 
		0,
		"AssassinJumpLand"
	},
