...
Schedule_t	slAlertSmallFlinch[] =
{
	{ 
		tlAlertSmallFlinch,
		ARRAYSIZE_HL ( tlAlertSmallFlinch ),
		0,
		0,
		"Alert Small Flinch"
	},
...
Schedule_t	slInvestigateSound[] =
{
	{ 
		tlInvestigateSound,
		ARRAYSIZE_HL ( tlInvestigateSound ), 
		bits_COND_NEW_ENEMY			|
		bits_COND_SEE_FEAR			|
		bits_COND_LIGHT_DAMAGE		|
		bits_COND_HEAVY_DAMAGE		|
...
Schedule_t	slPrimaryMeleeAttack[] =
{
	{ 
		...
		ARRAYSIZE_HL ( tlPrimaryMeleeAttack1 ), 
		bits_COND_NEW_ENEMY			|
		bits_COND_ENEMY_DEAD		|
		bits_COND_LIGHT_DAMAGE		|
		bits_COND_HEAVY_DAMAGE		|
...
Schedule_t	slSecondaryMeleeAttack[] =
{
	{ 
		...
		ARRAYSIZE_HL ( tlSecondaryMeleeAttack1 ), 
		bits_COND_NEW_ENEMY			|
		bits_COND_ENEMY_DEAD		|
		bits_COND_LIGHT_DAMAGE		|
		bits_COND_HEAVY_DAMAGE		|
...
Schedule_t	slChaseEnemyFailed[] =
{
	{ 
		tlChaseEnemyFailed,
		ARRAYSIZE_HL ( tlChaseEnemyFailed ), 
		bits_COND_NEW_ENEMY			|
		bits_COND_CAN_RANGE_ATTACK1	|
		bits_COND_CAN_MELEE_ATTACK1	|
		bits_COND_CAN_RANGE_ATTACK2	|
...
{
	{
		...
		ARRAYSIZE_HL ( tlBarnacleVictimGrab ),
		0,
		0,
		"Barnacle Victim"
	}
...
{
	{
		...
		ARRAYSIZE_HL ( tlBarnacleVictimChomp ),
		0,
		0,
		"Barnacle Chomp"
	}
...
Schedule_t slTeleportToScript[] =
{
	{ 
		tlScriptedTeleport,
		ARRAYSIZE_HL ( tlScriptedTeleport ),
...
Schedule_t	slTakeCoverFromOrigin[] =
{
	{ 
		...
		ARRAYSIZE_HL ( tlTakeCoverFromOrigin ), 
		bits_COND_NEW_ENEMY,
		0,
		"TakeCoverFromOrigin"
	},
...
Schedule_t	slTakeCoverFromBestSound[] =
{
	{ 
		...
		ARRAYSIZE_HL ( tlTakeCoverFromBestSound ), 
		bits_COND_NEW_ENEMY,
		0,
...
Schedule_t	slTakeCoverFromEnemy[] =
{
	{ 
		...
		ARRAYSIZE_HL ( tlTakeCoverFromEnemy ), 
		bits_COND_NEW_ENEMY,
		0,
		"tlTakeCoverFromEnemy"
	},
...
{
	return ScheduleInList( pName, m_scheduleList, ARRAYSIZE_HL(m_scheduleList) );
}
