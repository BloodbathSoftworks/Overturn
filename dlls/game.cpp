...
//OVERTURD
cvar_t  sv_burntime = {"sv_burntime","10", FCVAR_SERVER };
//OVERTURD
...
cvar_t	sk_plr_crowbarmp = {"sk_plr_crowbarmp","0"};
...
cvar_t	sk_plr_9mm_bulletmp = {"sk_plr_9mm_bulletmp","0"};
...
cvar_t	sk_plr_357_bulletmp = {"sk_plr_357_bulletmp","0"};
...
cvar_t	sk_plr_mp5_bulletmp = {"sk_plr_mp5_bulletmp","0"};
...
cvar_t	sk_plr_m203_grenademp = {"sk_plr_m203_grenademp","0"};


// Shotgun buckshot
cvar_t	sk_plr_12buckshot1 = {"sk_plr_12buckshot1","0"};
cvar_t	sk_plr_12buckshot2 = {"sk_plr_12buckshot2","0"};
cvar_t	sk_plr_12buckshot3 = {"sk_plr_12buckshot3","0"};
cvar_t	sk_plr_12buckshotmp = {"sk_plr_12buckshotmp","0"};
cvar_t	sk_plr_20buckshot1 = {"sk_plr_20buckshot1","0"};
cvar_t	sk_plr_20buckshot2 = {"sk_plr_20buckshot2","0"};
cvar_t	sk_plr_20buckshot3 = {"sk_plr_20buckshot3","0"};
cvar_t	sk_plr_20buckshotmp = {"sk_plr_20buckshotmp","0"};
...
cvar_t	sk_plr_xbow_bolt_clientmp = {"sk_plr_xbow_bolt_clientmp","0"};
...
cvar_t	sk_plr_xbow_bolt_monstermp = {"sk_plr_xbow_bolt_monstermp","0"};
...
cvar_t	sk_plr_rpgmp = {"sk_plr_rpgmp","0"};
...
cvar_t	sk_plr_gaussmp = {"sk_plr_gaussmp","0"};
...
cvar_t	sk_plr_egon_narrowmp = {"sk_plr_egon_narrowmp","0"};
...
cvar_t	sk_plr_egon_widemp = {"sk_plr_egon_widemp","0"};
...
cvar_t	sk_plr_hand_grenademp = {"sk_plr_hand_grenademp","0"};
...
cvar_t	sk_plr_satchelmp	= {"sk_plr_satchelmp","0"};
...
cvar_t	sk_plr_tripminemp = {"sk_plr_tripminemp","0"};
...
cvar_t	sk_mp5_bullet1 = {"sk_mp5_bullet1","0"};
cvar_t	sk_mp5_bullet2 = {"sk_mp5_bullet2","0"};
cvar_t	sk_mp5_bullet3 = {"sk_mp5_bullet3","0"};
...
//OVERTURD//
cvar_t	sk_plr_powerglove1 = {"sk_plr_powerglove1","0"};
cvar_t	sk_plr_powerglove2 = {"sk_plr_powerglove2","0"};
cvar_t	sk_plr_powerglove3 = {"sk_plr_powerglove3","0"};
cvar_t	sk_plr_powerglovemp = {"sk_plr_powerglovemp","0"};
...
cvar_t	sk_plr_flaregunmp = {"sk_plr_flaregunmp","0"};

cvar_t	sk_mon_burndmg1 = {"sk_mon_burndmg1","0"};
cvar_t	sk_mon_burndmg2 = {"sk_mon_burndmg2","0"};
cvar_t	sk_mon_burndmg3 = {"sk_mon_burndmg3","0"};
cvar_t	sk_mon_burndmgmp = {"sk_mon_burndmgmp","0"};
cvar_t	sk_plr_burndmg1 = {"sk_plr_burndmg1","0"};
cvar_t	sk_plr_burndmg2 = {"sk_plr_burndmg2","0"};
cvar_t	sk_plr_burndmg3 = {"sk_plr_burndmg3","0"};
cvar_t	sk_plr_burndmgmp = {"sk_plr_burndmgmp","0"};
//OVERTURD//
...
// REGISTER CVARS FOR SKILL LEVEL STUFF
	...
	CVAR_REGISTER ( &sk_plr_crowbarmp );
	...
	CVAR_REGISTER ( &sk_plr_9mm_bulletmp );
	...
	CVAR_REGISTER ( &sk_plr_357_bulletmp );

	// MP5 Round
	CVAR_REGISTER ( &sk_plr_mp5_bullet1 );// {"sk_plr_mp5_bullet1","0"};
	CVAR_REGISTER ( &sk_plr_mp5_bullet2 );// {"sk_plr_mp5_bullet2","0"};
	CVAR_REGISTER ( &sk_plr_mp5_bullet3 );// {"sk_plr_mp5_bullet3","0"};
	CVAR_REGISTER ( &sk_plr_mp5_bulletmp );// {"sk_plr_mp5_bullet3","0"};
	
	// M203 grenade
	CVAR_REGISTER ( &sk_plr_m203_grenade1 );// {"sk_plr_m203_grenade1","0"};
	CVAR_REGISTER ( &sk_plr_m203_grenade2 );// {"sk_plr_m203_grenade2","0"};
	CVAR_REGISTER ( &sk_plr_m203_grenade3 );// {"sk_plr_m203_grenade3","0"};
	CVAR_REGISTER ( &sk_plr_m203_grenademp );// {"sk_plr_m203_grenade3","0"};

	// Shotgun buckshot
	CVAR_REGISTER ( &sk_plr_12buckshot1 );// {"sk_plr_buckshot1","0"};
	CVAR_REGISTER ( &sk_plr_12buckshot2 );// {"sk_plr_buckshot2","0"};
	CVAR_REGISTER ( &sk_plr_12buckshot3 );// {"sk_plr_buckshot3","0"};
	CVAR_REGISTER ( &sk_plr_12buckshotmp );// {"sk_plr_buckshot3","0"};
	CVAR_REGISTER ( &sk_plr_20buckshot1 );// {"sk_plr_buckshot1","0"};
	CVAR_REGISTER ( &sk_plr_20buckshot2 );// {"sk_plr_buckshot2","0"};
	CVAR_REGISTER ( &sk_plr_20buckshot3 );// {"sk_plr_buckshot3","0"};
	CVAR_REGISTER ( &sk_plr_20buckshotmp );// {"sk_plr_buckshot3","0"};
	...
	CVAR_REGISTER ( &sk_plr_xbow_bolt_monstermp );// {"sk_plr_xbow_bolt3","0"};
	...
	CVAR_REGISTER ( &sk_plr_gaussmp );// {"sk_plr_gauss3","0"};
	...
	CVAR_REGISTER ( &sk_plr_egon_narrowmp );// {"sk_plr_egon_narrow3","0"};
	...
	CVAR_REGISTER ( &sk_plr_egon_widemp );// {"sk_plr_egon_wide3","0"};
	...
	CVAR_REGISTER ( &sk_plr_hand_grenademp );// {"sk_plr_hand_grenade3","0"};
	...
	CVAR_REGISTER ( &sk_mp5_bullet1 );// {"sk_mp5_bullet1","0"};
	CVAR_REGISTER ( &sk_mp5_bullet2 );// {"sk_mp5_bullet2","0"};
	CVAR_REGISTER ( &sk_mp5_bullet3 );// {"sk_mp5_bullet3","0"};
...
// END REGISTER CVARS FOR SKILL LEVEL STUFF
	...
	//power gloves
	CVAR_REGISTER ( &sk_plr_powerglove1 );
	CVAR_REGISTER ( &sk_plr_powerglove2 );
	CVAR_REGISTER ( &sk_plr_powerglove3 );
	CVAR_REGISTER ( &sk_plr_powerglovemp );

	//flaregun
	CVAR_REGISTER ( &sk_plr_flaregun1 );
	CVAR_REGISTER ( &sk_plr_flaregun2 );
	CVAR_REGISTER ( &sk_plr_flaregun3 );
	CVAR_REGISTER ( &sk_plr_flaregunmp );

	CVAR_REGISTER ( &sk_mon_burndmg1 );
	CVAR_REGISTER ( &sk_mon_burndmg2 );
	CVAR_REGISTER ( &sk_mon_burndmg3 );
	CVAR_REGISTER ( &sk_mon_burndmgmp );
	CVAR_REGISTER ( &sk_plr_burndmg1 );
	CVAR_REGISTER ( &sk_plr_burndmg2 );
	CVAR_REGISTER ( &sk_plr_burndmg3 );
	CVAR_REGISTER ( &sk_plr_burndmgmp );
	//OVERTURD//
