...
extern void EXEmitSound( edict_t *entity, int channel, const char *sample, float volume, float attenuation, int fFlags, int pitch, int client=0 );
extern void EXEmitAmbientSound(edict_t *entity, float *pos, const char *samp, float vol, float attenuation, int fFlags, int pitch, int client=0 );
//==============SOUND ENGINE FUNCTIONS==============//
...
#ifndef CLIENT_DLL
	#define PRECACHE_SOUND	(*EXPrecacheSound)
#else
	#define PRECACHE_SOUND	__noop
#endif
...
#ifndef CLIENT_DLL
	#define EMIT_SOUND_DYN2 (*EXEmitSound)
#else
	#define EMIT_SOUND_DYN2 __noop
#endif
...
#ifndef CLIENT_DLL
	#define EMIT_AMBIENT_SOUND			(*EXEmitAmbientSound)
#else
	#define	EMIT_AMBIENT_SOUND			__noop
#endif
