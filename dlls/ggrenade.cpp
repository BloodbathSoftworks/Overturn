...
// UNDONE: temporary scorching for PreAlpha - find a less sleazy permanant solution.
void CGrenade::Explode( TraceResult *pTrace, int bitsDamageType )
{
	...
	//UTIL_ExplosionSound(pev->origin);
	PLAYBACK_EVENT_FULL( FEV_GLOBAL, edict(), m_usQExplosion, 0.0, (float *)&pev->origin, (float *)&g_vecZero, 0.0, 0.0, 0, 0, 0, 0 );

	UTIL_ScreenShake( pev->origin, 5.0, 200.0, 0.75, 250.0 );
