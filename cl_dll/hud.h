...
#define RGB_YELLOWISH 0xF70000 //255,160,0
...
//-----------------------------------------------------
//
class CHudItems: public CHudBase
{
public:
	int Init( void );
	int VidInit( void );
...
private:
	int m_HUD_items;
	int m_HUD_rcard, m_HUD_bcard, m_HUD_ycard;
	int item_rcard, item_bcard, item_ycard;
	int m_HUD_healthkit;
	int m_HUD_healthkitx;
	int m_HUD_health1;
	int m_HUD_health2;
	int m_HUD_health3;
	int m_HUD_health4;
...
public:
   ...
   void MessageAdd2( int type, float time, char *text, char *text2 );
   void Reset( void );
...
extern int g_iRoomType;//JIW
extern int g_iInZoom;
extern float g_flFOV;
