...
void CSatchelCharge :: BounceSound( void )
{
	...
	case 3:	EMIT_SOUND(ENT(pev), CHAN_VOICE, "weapons/g_bounce4.wav", 1, ATTN_NORM);	break;
	case 4:	EMIT_SOUND(ENT(pev), CHAN_VOICE, "weapons/g_bounce5.wav", 1, ATTN_NORM);	break;
	}
}
