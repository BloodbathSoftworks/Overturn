...
void Game_HookEvents( void )
{
	...
	gEngfuncs.pfnHookEvent( "events/sshotgun1.sc",				EV_FireStakeoutSingle );
	gEngfuncs.pfnHookEvent( "events/sshotgun2.sc",				EV_FireStakeoutSemi );
	...
	gEngfuncs.pfnHookEvent( "events/flaregun.sc",				EV_FireFlareGun );
	gEngfuncs.pfnHookEvent( "events/flamethrower.sc",				EV_FireFlameThrower );

	gEngfuncs.pfnHookEvent( "events/firefield.sc",				EV_FireField );
	gEngfuncs.pfnHookEvent( "events/flareburst.sc",				EV_FlareBurst );
	gEngfuncs.pfnHookEvent( "events/qrockettrail.sc",				EV_QRocketTrail );
	gEngfuncs.pfnHookEvent( "events/qexplosion.sc",				EV_QExplosion );
