...
#define		BLOOD_COLOR_REDP		(BYTE)67
...
extern void			UTIL_ExplosionSound( Vector origin );
...
extern void			UTIL_SetOrigin			( entvars_t *ent, const Vector &vecOrigin );
...
void UTIL_CustomMessage( CBaseEntity *pEntity, int type, const char *pMessage = NULL, const char *pMessage2 = NULL );
...
#define PRECACHE_SOUND_ARRAY( a ) \
	{ for (int i = 0; i < ARRAYSIZE_HL( a ); i++ ) PRECACHE_SOUND((char *) a [i]); }

#define EMIT_SOUND_ARRAY_DYN( chan, array ) \
	EMIT_SOUND_DYN ( ENT(pev), chan , array [ RANDOM_LONG(0,ARRAYSIZE_HL( array )-1) ], 1.0, ATTN_NORM, 0, RANDOM_LONG(95,105) ); 

#define RANDOM_SOUND_ARRAY( array ) (array) [ RANDOM_LONG(0,ARRAYSIZE_HL( (array) )-1) ]
