...
public:
	...
	void EXPORT RopeFrame( void );

	int m_iSegments;
	BOOL m_fDisabled;
	Vector vecAngles;

	char m_szEndingModel[64];
	char m_szBodyModel[64];
	CBaseEntity *m_hSegments[100];
};
//=======================
// Opposing Force Rope Segment
//=======================
class CRopeSegment : public CBaseToggle
{
public:
	void Spawn ( void );
...
public:
	static CRopeSegment *CreateSample( Vector vecOrigin, Vector vecAngles, char *m_BodyModel, CBaseEntity *pOwner );
};
#endif