...
extern inline void PlaySound( char *szSound, float vol = VOL_NORM, int channel = CHAN_ITEM, int pitch = 100, int flags = 0 );
...
private:
	...
	int PlayOgg( char *sample, int flags );//JIW//void
