...
{
	PRECACHE_MODEL("models/v_sshotgun.mdl");
	PRECACHE_MODEL("models/w_sshotgun.mdl");
	PRECACHE_MODEL("models/p_sshotgun.mdl");
...
int CShotgun2::AddToPlayer( CBasePlayer *pPlayer )
{
...
{
	return DefaultDeploy( "models/v_sshotgun.mdl", "models/p_sshotgun.mdl", SHOTGUN_DRAW, "shotgun" );
}
