...
void CHGrunt :: GibMonster ( void )
{
	...
	{// throw a gun if the grunt has one
		...
		{
			pGun = DropItem( "ammo_m203grenades", vecGunPos, vecGunAngles );
			if ( pGun )
			{
				pGun->pev->velocity = Vector (RANDOM_FLOAT(-100,100), RANDOM_FLOAT(-100,100), RANDOM_FLOAT(200,300));
				pGun->pev->avelocity = Vector ( 0, RANDOM_FLOAT( 200, 400 ), 0 );
...
void CHGrunt :: Shotgun ( void )
{
	...
	FireBullets(gSkillData.hgruntShotgunPellets, vecShootOrigin, vecShootDir, VECTOR_CONE_15DEGREES, 2048, BULLET_PLAYER_12BUCKSHOT, 0 ); // shoot +-7.5 degrees
...
void CHGrunt :: HandleAnimEvent( MonsterEvent_t *pEvent )
{
	...
	switch( pEvent->event )
	{
		case HGRUNT_AE_DROP_GUN:
			...
			if (FBitSet( pev->weapons, HGRUNT_GRENADELAUNCHER ))
			{
				DropItem( "ammo_m203grenades", BodyTarget( pev->origin ), vecGunAngles );
			}
...
//	m_flNextPainTime	= gpGlobals->time;
	...
	if (pev->weapons == 0)
	{
		...
		// pev->weapons = HGRUNT_MP5 | HGRUNT_GRENADELAUNCHER;
	}
...
Schedule_t	slGruntCombatFail[] =
{
	{
		tlGruntCombatFail,
		ARRAYSIZE_HL ( tlGruntCombatFail ),
		bits_COND_CAN_RANGE_ATTACK1	|
		bits_COND_CAN_RANGE_ATTACK2,
		0,
		"Grunt Combat Fail"
...
Schedule_t	slGruntVictoryDance[] =
{
	{ 
		tlGruntVictoryDance,
		ARRAYSIZE_HL ( tlGruntVictoryDance ), 
		bits_COND_NEW_ENEMY		|
...
Schedule_t slGruntEstablishLineOfFire[] =
{
	{ 
		...
		ARRAYSIZE_HL ( tlGruntEstablishLineOfFire ),
		bits_COND_NEW_ENEMY			|
...
Schedule_t	slGruntFoundEnemy[] =
{
	{ 
		tlGruntFoundEnemy,
		ARRAYSIZE_HL ( tlGruntFoundEnemy ), 
		bits_COND_HEAR_SOUND,
...
Schedule_t	slGruntCombatFace[] =
{
	{ 
		tlGruntCombatFace1,
		ARRAYSIZE_HL ( tlGruntCombatFace1 ), 
		bits_COND_NEW_ENEMY				|
		bits_COND_ENEMY_DEAD			|
		bits_COND_CAN_RANGE_ATTACK1		|
		bits_COND_CAN_RANGE_ATTACK2,
...
Schedule_t	slGruntSignalSuppress[] =
{
	{ 
		...
		ARRAYSIZE_HL ( tlGruntSignalSuppress ), 
		bits_COND_ENEMY_DEAD		|
		bits_COND_LIGHT_DAMAGE		|
		bits_COND_HEAVY_DAMAGE		|
		bits_COND_HEAR_SOUND		|
...
Schedule_t	slGruntWaitInCover[] =
{
	{ 
		tlGruntWaitInCover,
		ARRAYSIZE_HL ( tlGruntWaitInCover ), 
		bits_COND_NEW_ENEMY			|
		bits_COND_HEAR_SOUND		|
		bits_COND_CAN_RANGE_ATTACK1	|
		bits_COND_CAN_RANGE_ATTACK2	|
...
Schedule_t	slGruntTakeCover[] =
{
	{ 
		tlGruntTakeCover1,
		ARRAYSIZE_HL ( tlGruntTakeCover1 ), 
		0,
		0,
		"TakeCover"
	},
...
Schedule_t	slGruntGrenadeCover[] =
{
	{ 
		...
		ARRAYSIZE_HL ( tlGruntGrenadeCover1 ), 
		0,
		0,
		"GrenadeCover"
	},
...
Schedule_t	slGruntTossGrenadeCover[] =
{
	{ 
		...
		ARRAYSIZE_HL ( tlGruntTossGrenadeCover1 ), 
		0,
		0,
		"TossGrenadeCover"
	},
...
Schedule_t	slGruntTakeCoverFromBestSound[] =
{
	{ 
		...
		ARRAYSIZE_HL ( tlGruntTakeCoverFromBestSound ), 
		0,
		0,
...
Schedule_t slGruntHideReload[] = 
{
	{
		tlGruntHideReload,
		ARRAYSIZE_HL ( tlGruntHideReload ),
		bits_COND_HEAVY_DAMAGE	|
		bits_COND_HEAR_SOUND,
...
Schedule_t	slGruntRangeAttack1A[] =
{
	{ 
		...
		ARRAYSIZE_HL ( tlGruntRangeAttack1A ), 
		bits_COND_NEW_ENEMY			|
		bits_COND_ENEMY_DEAD		|
		bits_COND_HEAVY_DAMAGE		|
...
Schedule_t	slGruntRangeAttack1B[] =
{
	{ 
		...
		ARRAYSIZE_HL ( tlGruntRangeAttack1B ), 
		bits_COND_NEW_ENEMY			|
		bits_COND_ENEMY_DEAD		|
		bits_COND_HEAVY_DAMAGE		|
		bits_COND_ENEMY_OCCLUDED	|
...
Schedule_t	slGruntRangeAttack2[] =
{
	{ 
		tlGruntRangeAttack2,
		ARRAYSIZE_HL ( tlGruntRangeAttack2 ), 
		0,
		0,
		"RangeAttack2"
	},
...
Schedule_t	slGruntRepelAttack[] =
{
	{ 
		tlGruntRepelAttack,
		ARRAYSIZE_HL ( tlGruntRepelAttack ), 
		bits_COND_ENEMY_OCCLUDED,
		0,
		"Repel Attack"
	},
