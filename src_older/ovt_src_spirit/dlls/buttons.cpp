...
int CBaseButton::TakeDamage( entvars_t* pevInflictor, entvars_t* pevAttacker, float flDamage, int bitsDamageType )
{
	...
	{
		EMIT_AMBIENT_SOUND(ENT(pev), pev->origin, (char*)STRING(pev->noise), 1, ATTN_NORM, 0, PITCH_NORM);
...
void DoSpark(entvars_t *pev, const Vector &location )
{
	...
	{
		case 0: EMIT_AMBIENT_SOUND(ENT(pev), pev->origin, "buttons/spark1.wav", flVolume, ATTN_NORM, 0, PITCH_NORM);	break;
		case 1: EMIT_AMBIENT_SOUND(ENT(pev), pev->origin, "buttons/spark2.wav", flVolume, ATTN_NORM, 0, PITCH_NORM);	break;
		case 2: EMIT_AMBIENT_SOUND(ENT(pev), pev->origin, "buttons/spark3.wav", flVolume, ATTN_NORM, 0, PITCH_NORM);	break;
		case 3: EMIT_AMBIENT_SOUND(ENT(pev), pev->origin, "buttons/spark4.wav", flVolume, ATTN_NORM, 0, PITCH_NORM);	break;
		case 4: EMIT_AMBIENT_SOUND(ENT(pev), pev->origin, "buttons/spark5.wav", flVolume, ATTN_NORM, 0, PITCH_NORM);	break;
		case 5: EMIT_AMBIENT_SOUND(ENT(pev), pev->origin, "buttons/spark6.wav", flVolume, ATTN_NORM, 0, PITCH_NORM);	break;
	}
}
