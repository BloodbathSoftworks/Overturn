...
void CBreakable::MaterialSoundRandom( edict_t *pEdict, Materials soundMaterial, float volume )
{
	...
	if ( soundCount )
		EMIT_SOUND( pEdict, CHAN_BODY, pSoundList[ RANDOM_LONG(0,soundCount-1) ], volume, ATTN_NORM );
}
...
//		return;
	...
	if (i)
		EMIT_SOUND_DYN(ENT(pev), CHAN_VOICE, rgpsz[RANDOM_LONG(0,i-1)], fvol, ATTN_NORM, SND_AMBIENT, pitch);
}
...
void CBreakable::Die( void )
{
	...
	case matGlass:
		switch ( RANDOM_LONG(0,1) )
		{
		case 0:	UTIL_EmitAmbientSound(ENT(0), Center(), "debris/bustglass1.wav", fvol, ATTN_NORM, SND_AMBIENT, pitch);
			break;
		case 1:	UTIL_EmitAmbientSound(ENT(0), Center(),"debris/bustglass2.wav", fvol, ATTN_NORM, SND_AMBIENT, pitch);	
			break;
		}
		cFlag = BREAK_GLASS;
		break;
	...
	case matWood:
		switch ( RANDOM_LONG(0,1) )
		{
		case 0:	UTIL_EmitAmbientSound(ENT(0), Center(),"debris/bustcrate1.wav", fvol, ATTN_NORM, SND_AMBIENT, pitch);	
			break;
		case 1:	UTIL_EmitAmbientSound(ENT(0), Center(),"debris/bustcrate2.wav", fvol, ATTN_NORM, SND_AMBIENT, pitch);	
			break;
		}
		cFlag = BREAK_WOOD;
		break;
	...
	case matMetal:
		switch ( RANDOM_LONG(0,1) )
		{
		case 0:	UTIL_EmitAmbientSound(ENT(0), Center(),"debris/bustmetal1.wav", fvol, ATTN_NORM, SND_AMBIENT, pitch);	
			break;
		case 1:	UTIL_EmitAmbientSound(ENT(0), Center(),"debris/bustmetal2.wav", fvol, ATTN_NORM, SND_AMBIENT, pitch);	
			break;
		}
		cFlag = BREAK_METAL;
		break;
	...
	case matFlesh:
		switch ( RANDOM_LONG(0,1) )
		{
		case 0:	UTIL_EmitAmbientSound(ENT(0), Center(),"debris/bustflesh1.wav", fvol, ATTN_NORM, SND_AMBIENT, pitch);	
			break;
		case 1:	UTIL_EmitAmbientSound(ENT(0), Center(),"debris/bustflesh2.wav", fvol, ATTN_NORM, SND_AMBIENT, pitch);	
			break;
		}
		cFlag = BREAK_FLESH;
		break;
	...
	case matCinderBlock:
		switch ( RANDOM_LONG(0,1) )
		{
		case 0:	UTIL_EmitAmbientSound(ENT(0), Center(),"debris/bustconcrete1.wav", fvol, ATTN_NORM, SND_AMBIENT, pitch);	
			break;
		case 1:	UTIL_EmitAmbientSound(ENT(0), Center(),"debris/bustconcrete2.wav", fvol, ATTN_NORM, SND_AMBIENT, pitch);	
			break;
		}
	...
	case matCeilingTile:
		UTIL_EmitAmbientSound(ENT(0), Center(),"debris/bustceiling.wav", fvol, ATTN_NORM, SND_AMBIENT, pitch);
		break;
	}
