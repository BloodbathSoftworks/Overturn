...
#define WEAPON_POWERGLOVE		1
#define	WEAPON_GLOCK			2
#define WEAPON_FLAREGUN			3
#define WEAPON_PYTHON			4
#define WEAPON_SHOTGUN			5
#define WEAPON_STAKEOUT			6
#define WEAPON_M16A2			7
#define WEAPON_FLAMETHROWER		8
#define WEAPON_RPG				9
...
#define MAX_PLAYER_MEDKITS		5
#define MAX_PLAYER_BATTERIES	5

// weapon weight factors (for auto-switching)   (-1 = noswitch)
#define CROWBAR_WEIGHT		0
#define POWERGLOVE_WEIGHT	0
#define GLOCK_WEIGHT		10
#define PYTHON_WEIGHT		15
#define MP5_WEIGHT			15
#define M16A2_WEIGHT		15
#define SHOTGUN_WEIGHT		15
#define STAKEOUT_WEIGHT		15
...
#define EAGLE_WEIGHT		25
#define KNIFE_WEIGHT		0
#define M249_WEIGHT			25
#define M40A1_WEIGHT		25
#define DISPLACER_WEIGHT	25
#define SPORELAUNCHER_WEIGHT	25
#define SHOCKRIFLE_WEIGHT	25
#define FLARE_WEIGHT	10
#define FLAME_WEIGHT	25

// weapon clip/carry ammo capacities
#define URANIUM_MAX_CARRY		100
#define POLONIUM_MAX_CARRY		120
#define	_9MM_MAX_CARRY			252
#define	_10MM_MAX_CARRY			250
#define _357_MAX_CARRY			36
#define _12BUCKSHOT_MAX_CARRY	128
#define _20BUCKSHOT_MAX_CARRY	96
#define BOLT_MAX_CARRY			50
#define ROCKET_MAX_CARRY		15
#define HANDGRENADE_MAX_CARRY	10
#define SATCHEL_MAX_CARRY		5
#define TRIPMINE_MAX_CARRY		5
#define SNARK_MAX_CARRY			15
#define HORNET_MAX_CARRY		25
#define M203_GRENADE_MAX_CARRY	10
#define _762_MAX_CARRY			15
#define _556_MAX_CARRY			200
#define SPORE_MAX_CARRY			20
#define SHOCK_MAX_CARRY			10
#define FLARE_MAX_CARRY			20
#define FLAME_MAX_CARRY			100
...
#define STAKEOUT_MAX_CLIP		12
#define CROSSBOW_MAX_CLIP		5
#define RPG_MAX_CLIP			5//1
...
#define SPORE_MAX_CLIP			5
#define FLARE_MAX_CLIP			1
...
#define M16A2_DEFAULT_GIVE			15
#define M16A2_DEFAULT_AMMO			15
#define SHOTGUN_DEFAULT_GIVE		12
#define STAKEOUT_DEFAULT_GIVE		8
#define CROSSBOW_DEFAULT_GIVE		5
#define RPG_DEFAULT_GIVE			5//1
...
#define AMMO_12BUCKSHOTBOX_GIVE	12
#define AMMO_20BUCKSHOTBOX_GIVE	3
...
#define AMMO_FLARE_GIVE			5
#define AMMO_FLAME_GIVE			40
...
typedef	enum
{
	...
	BULLET_PLAYER_12BUCKSHOT, // shotgun
	BULLET_PLAYER_20BUCKSHOT, // shotgun
	BULLET_PLAYER_CROWBAR, // crowbar swipe
	BULLET_PLAYER_556, // m249
	BULLET_PLAYER_KNIFE, // knife slash
...
public:
	...
	void DrainClip(CBasePlayer* pPlayer, BOOL keep, int i9mm, int i10mm, int i357, int i12Buck, int i20Buck, int iBolt, int iM203Gren, int iRock, int iUranium, int iPolonium, int iSatchel, int iSnark, int iTrip, int iGren );
	
	int	PrimaryAmmoIndex(); 
	int	SecondaryAmmoIndex(); 

	float GetSequenceTime( int iAnim );
...
extern DLL_GLOBAL unsigned short m_usFireField;//JIW
extern DLL_GLOBAL unsigned short m_usFlareBurst;//JIW
extern DLL_GLOBAL unsigned short m_usQRocketTrail;//JIW
extern DLL_GLOBAL unsigned short m_usQExplosion;//JIW
...
class CPythonLaser : public CBaseEntity
{
	void Spawn( void );
	void Precache( void );
...
public:
	...
	static CPythonLaser *CreateSpot( void );
};
...
#endif
class CM16A2 : public CBasePlayerWeapon
{
public:
	void Spawn( void );
	void Precache( void );
...
class CStakeout : public CBasePlayerWeapon
{
public:
...
class CPowerGlove : public CBasePlayerWeapon
{
public:
	void Spawn( void );
	void Precache( void );
