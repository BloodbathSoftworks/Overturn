...
//======================================================================================
// Show the TAB Menu
CMenuPanel* TeamFortressViewport::ShowTABMenu()
{
    // Don't open menus in demo playback
    if ( gEngfuncs.pDemoAPI->IsPlayingback() )
        return NULL;
...
void TeamFortressViewport::CreateTABMenu()
{
    // Create the panel
    m_pTABMenu = new CTABMenuPanel(100, false, 0, 0, ScreenWidth, ScreenHeight);
    m_pTABMenu->setParent(this);
    m_pTABMenu->setVisible( false );
}
...
int TeamFortressViewport::MsgFunc_TABMenu( const char *pszName, int iSize, void *pbuf )
{
	ShowVGUIMenu( MENU_TABMENU );
	return 1;
}
