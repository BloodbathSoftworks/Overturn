...
class CMP5AmmoClip : public CBasePlayerAmmo
{
	...
	{ 
		Precache( );
		SET_MODEL(ENT(pev), "models/w_mp5clip.mdl");
	...
	{ 
		int bResult = (pOther->GiveAmmo( AMMO_MP5CLIP_GIVE, "10mm", _10MM_MAX_CARRY) != -1);
		if (bResult)
		{
...
class CMP5AmmoGrenade : public CBasePlayerAmmo
{
	...
	{ 
		Precache( );
		SET_MODEL(ENT(pev), "models/w_m203grenade.mdl");
		CBasePlayerAmmo::Spawn( );
	}
	void Precache( void )
	{
		PRECACHE_MODEL ("models/w_m203grenade.mdl");
		PRECACHE_SOUND("items/ammopickup2.wav");
	}
	BOOL AddAmmo( CBaseEntity *pOther ) 
	{ 
...
LINK_ENTITY_TO_CLASS( ammo_m203grenades, CMP5AmmoGrenade );
