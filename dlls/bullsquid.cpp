...
BOOL CBullsquid :: FValidateHintType ( short sHint )
{
	...
	for ( i = 0 ; i < ARRAYSIZE_HL ( sSquidHints ) ; i++ )
	{
...
Schedule_t	slSquidRangeAttack1[] =
{
	{ 
		tlSquidRangeAttack1,
		ARRAYSIZE_HL ( tlSquidRangeAttack1 ), 
		bits_COND_NEW_ENEMY			|
...
Schedule_t slSquidChaseEnemy[] =
{
	{ 
		tlSquidChaseEnemy1,
		ARRAYSIZE_HL ( tlSquidChaseEnemy1 ),
		bits_COND_NEW_ENEMY			|
		bits_COND_ENEMY_DEAD		|
...
Schedule_t slSquidSniffAndEat[] =
{
	{
		tlSquidSniffAndEat,
		ARRAYSIZE_HL( tlSquidSniffAndEat ),
		bits_COND_LIGHT_DAMAGE	|
		bits_COND_HEAVY_DAMAGE	|
		bits_COND_NEW_ENEMY	,
