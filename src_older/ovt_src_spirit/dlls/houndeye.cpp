...
BOOL CHoundeye :: FValidateHintType ( short sHint )
{
	...
	for ( i = 0 ; i < ARRAYSIZE_HL ( sHoundHints ) ; i++ )
	{
...
Schedule_t	slHoundWakeUrgent[] =
{
	{
		tlHoundWakeUrgent,
		ARRAYSIZE_HL ( tlHoundWakeUrgent ),
		0,
		0,
		"WakeUrgent"
	},
...
Schedule_t	slHoundSpecialAttack1[] =
{
	{ 
		...
		ARRAYSIZE_HL ( tlHoundSpecialAttack1 ), 
		bits_COND_NEW_ENEMY			|
		bits_COND_LIGHT_DAMAGE		|
		bits_COND_HEAVY_DAMAGE		|
...
Schedule_t	slHoundHopRetreat[] =
{
	{ 
		tlHoundHopRetreat,
		ARRAYSIZE_HL ( tlHoundHopRetreat ), 
		0,
		0,
		"Hound Hop Retreat"
	},
...
Schedule_t	slHoundCombatFailPVS[] =
{
	{ 
		...
		ARRAYSIZE_HL ( tlHoundCombatFailPVS ), 
		bits_COND_NEW_ENEMY			|
		bits_COND_LIGHT_DAMAGE		|
		bits_COND_HEAVY_DAMAGE,
		0,
...
Schedule_t	slHoundCombatFailNoPVS[] =
{
	{ 
		...
		ARRAYSIZE_HL ( tlHoundCombatFailNoPVS ), 
		bits_COND_NEW_ENEMY			|
		bits_COND_LIGHT_DAMAGE		|
		bits_COND_HEAVY_DAMAGE,
		0,
