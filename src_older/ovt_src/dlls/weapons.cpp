...
TYPEDESCRIPTION	CShotgun2::m_SaveData[] = 
{
	DEFINE_FIELD( CShotgun2, m_flNextReload, FIELD_TIME ),
	DEFINE_FIELD( CShotgun2, m_fInSpecialReload, FIELD_INTEGER ),
	DEFINE_FIELD( CShotgun2, m_flNextReload, FIELD_TIME ),
	// DEFINE_FIELD( CShotgun, m_iShell, FIELD_INTEGER ),
	DEFINE_FIELD( CShotgun2, m_flPumpTime, FIELD_TIME ),
};
IMPLEMENT_SAVERESTORE( CShotgun2, CBasePlayerWeapon );
