...
// PLAYER WEAPONS
	...
	// Shotgun buckshot
	gSkillData.plrDmg12Buckshot = GetSkillCvar( "sk_plr_12buckshot");
	gSkillData.plrDmg20Buckshot = GetSkillCvar( "sk_plr_20buckshot");
	...
	gSkillData.monDmgMP5 = GetSkillCvar ("sk_mp5_bullet" );
...
// via SKILLS.CFG. Any player hivehand tuning must take place in the code. (sjb)
	...
	//OVERTURD
	gSkillData.plrDmgPowerGlove = GetSkillCvar( "sk_plr_powerglove");
	gSkillData.plrDmgFlaregun = GetSkillCvar( "sk_plr_flaregun");

	gSkillData.monDmgBurn = GetSkillCvar( "sk_mon_burndmg");
	gSkillData.plrDmgBurn = GetSkillCvar( "sk_plr_burndmg");
	//OVERTURD
}
